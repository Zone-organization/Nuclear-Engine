...
#define NUCLEAR_PLATFORM_MAX_KEYBOARD_KEYS 256
#define NUCLEAR_PLATFORM_MAX_MOUSE_KEYS 10

namespace NuclearPlatform {
	namespace Input {
		class NPAPI Keyboard
		{
		public:
			struct Key
			{
				enum Code
				{
					...
					LSystem,      // The left Platform specific key: window (Windows and Linux), apple (MacOS X), ...
					RControl,     // The right Control key
					RShift,       // The right Shift key
					RAlt,         // The right Alt key
					RSystem,      // The right Platform specific key: window (Windows and Linux), apple (MacOS X), ...
					Menu,         // The Menu key
					LBracket,     // The [ key
					RBracket,     // The ] key
					SemiColon,    // The ; key
