...
namespace Math
{
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> Orthographic(T left, T right, T bottom, T top)
	{
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> Orthographic(T left, T right, T bottom, T top, T zNear, T zFar)
	{
