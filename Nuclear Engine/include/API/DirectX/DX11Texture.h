	...
	namespace API
	{
		namespace DirectX
		{
			...
			public:
				...
				static void Create(DX11Texture* texture, Texture_Data* TexData, Texture_Desc* Desc);
				static void Create(DX11Texture* texture, const std::array<Texture_Data*, 6>& data, Texture_Desc* Desc);
