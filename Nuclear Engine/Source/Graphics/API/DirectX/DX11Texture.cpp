...
#include <Graphics/API/DirectX\DX11Types.h>
	...
	namespace Graphics
	{
		namespace API
		{
			namespace DirectX
			{
				...
				void DX11Texture::Create(DX11Texture* texture, const std::array<Graphics::API::Texture_Data, 6>& data, const Texture_Desc& Desc)
				{
					texture->desc = Desc;
