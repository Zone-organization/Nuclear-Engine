...
struct JoystickState
{
    ...
    #include <ThirdParty/SFML/Window/Win32/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_LINUX)

    #include <ThirdParty/SFML/Window/Unix/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

    #include <ThirdParty/SFML/Window/FreeBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_OPENBSD)

    #include <ThirdParty/SFML/Window/OpenBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

    #include <ThirdParty/SFML/Window/OSX/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

    #include <ThirdParty/SFML/Window/iOS/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

    #include <ThirdParty/SFML/Window/Android/JoystickImpl.hpp>
