...
#include <ThirdParty/SFML/OpenGL.hpp>
#include <algorithm>
#include <vector>
#include <string>
#include <set>
...
#pragma comment(lib,"opengl32.lib")
        ...
        #include <ThirdParty/SFML/Window/Unix/GlxContext.hpp>
        typedef sf::priv::GlxContext ContextType;

    #elif defined(SFML_SYSTEM_MACOS)

        #include <ThirdParty/SFML/Window/OSX/SFContext.hpp>
        ...
        #include <ThirdParty/SFML/Window/iOS/EaglContext.hpp>
        typedef sf::priv::EaglContext ContextType;

    #else

        #include <ThirdParty/SFML/Window/EglContext.hpp>
