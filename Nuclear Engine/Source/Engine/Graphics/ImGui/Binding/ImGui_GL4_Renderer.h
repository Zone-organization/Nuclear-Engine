...
namespace NuclearEngine
{
	namespace Graphics
	{
		...
		bool ImGui_GL4_Renderer_Initialize()
		{
			...
			glShaderSource(g_VertHandle, 1, &vertex_shader_glsl_410_core, NULL);
			glCompileShader(g_VertHandle);
			CheckShader(g_VertHandle, "vertex shader");

			g_FragHandle = glCreateShader(GL_FRAGMENT_SHADER);
			glShaderSource(g_FragHandle, 1, &fragment_shader_glsl_410_core, NULL);
			...
			Log.Info("[ImGui] Initialized ImGui_GL4_Renderer.\n");
			return true;
		}

		void ImGui_GL4_Renderer_Shutdown()
		{
			...
			Log.Info("[ImGui] Shutting down ImGui_GL4_Renderer...\n");

		}
		void ImGui_GL4_Renderer_NewFrame()
		{
		}
		void ImGui_GL4_Renderer_RenderDrawData(ImDrawData * draw_data)
		{
