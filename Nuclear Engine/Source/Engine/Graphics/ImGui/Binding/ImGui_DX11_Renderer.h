...
namespace NuclearEngine
{
	namespace Graphics
	{
		...
		void ImGui_DX11_Renderer_CreateFontsTexture();
		...
		bool ImGui_DX11_Renderer_Initialize()
		{
			...
			Log.Info("[ImGui] Initialized ImGui_DX11_Renderer.\n");
			return true;
		}

		void ImGui_DX11_Renderer_Shutdown()
		{
		...
		void ImGui_DX11_Renderer_NewFrame()
		{
			if (!g_pFontSampler)
				ImGui_DX11_Renderer_CreateFontsTexture();
		}
		void ImGui_DX11_Renderer_RenderDrawData(ImDrawData * draw_data)
		{
