...
namespace NuclearEngine {
	...
	std::array<API::Texture_Data, 6> AssetManager::LoadTextureCubeFromFile(const std::array<std::string, 6>& Paths, const API::Texture_Desc& Desc)
	{
		...
		data1 = LoadTextureFromFile(Paths.at(0), Desc);
		data2 = LoadTextureFromFile(Paths.at(1), Desc);
		data3 = LoadTextureFromFile(Paths.at(2), Desc);
		data4 = LoadTextureFromFile(Paths.at(3), Desc);
		data5 = LoadTextureFromFile(Paths.at(4), Desc);
		data6 = LoadTextureFromFile(Paths.at(5), Desc);
