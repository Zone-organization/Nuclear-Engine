...
public:
	...
	void Load()
	{
		//CubeShader = new API::Shader();
		LampShader = new API::Shader("LampShader",
			Core::FileSystem::LoadFileToString("Assets/Demo6/Shaders/OpenGL/LampShader.vs").c_str(),
			Core::FileSystem::LoadFileToString("Assets/Demo6/Shaders/OpenGL/LampShader.fs").c_str(),
			nullptr,
			ShaderType::GLSL);
