...
public:
	...
	void Load()
	{
		CubeShader = new API::Shader("CubeShader",
			Core::FileSystem::LoadFileToString("Assets/Demo5/Shaders/DirectX/CubeShader.vs").c_str(),
			Core::FileSystem::LoadFileToString("Assets/Demo5/Shaders/DirectX/CubeShader.ps").c_str(),
			nullptr,
			ShaderType::HLSL);
